...
uplink_power = 20; % in dBm
downlink_power = 27; % in dBm
backhaul_power = 37; %in dBm
...
BS2 = BaseStationsSetup(grid, 16, bs_count, mec_count, mec_clock, ...
    ...
    downlink_carrier_frequency_4g, downlink_carrier_frequency_5g, ...
    backhaul_carrier_frequency_4g, backhaul_carrier_frequency_5g, ...
    uplink_power+1, downlink_power+1, backhaul_power+1, noise_spectral_density);

BS2 = calculateRadii(BS2, ...
    uplink_power+1, downlink_power+1, backhaul_power+1, ...
    uplink_carrier_frequency_4g, downlink_carrier_frequency_4g, backhaul_carrier_frequency_4g, ...
    uplink_carrier_frequency_5g, downlink_carrier_frequency_5g, backhaul_carrier_frequency_5g, ...
    uplink_bandwidth_4g, uplink_bandwidth_5g, ...
    downlink_bandwidth_4g, downlink_bandwidth_5g, ...
...
BS3 = BaseStationsSetup(grid, 16, bs_count, mec_count, mec_clock, ...
    ...
    downlink_carrier_frequency_4g, downlink_carrier_frequency_5g, ...
    backhaul_carrier_frequency_4g, backhaul_carrier_frequency_5g, ...
    uplink_power+2, downlink_power+2, backhaul_power+2, noise_spectral_density);

BS3 = calculateRadii(BS3, ...
    uplink_power+2, downlink_power+2, backhaul_power+2, ...
    uplink_carrier_frequency_4g, downlink_carrier_frequency_4g, backhaul_carrier_frequency_4g, ...
    uplink_carrier_frequency_5g, downlink_carrier_frequency_5g, backhaul_carrier_frequency_5g, ...
    uplink_bandwidth_4g, uplink_bandwidth_5g, ...
    downlink_bandwidth_4g, downlink_bandwidth_5g, ...
...
BS4 = BaseStationsSetup(grid, 16, bs_count, mec_count, mec_clock, ...
    ...
    downlink_carrier_frequency_4g, downlink_carrier_frequency_5g, ...
    backhaul_carrier_frequency_4g, backhaul_carrier_frequency_5g, ...
    uplink_power+3, downlink_power+3, backhaul_power+3, noise_spectral_density);

BS4 = calculateRadii(BS4, ...
    uplink_power+3, downlink_power+3, backhaul_power+3, ...
    uplink_carrier_frequency_4g, downlink_carrier_frequency_4g, backhaul_carrier_frequency_4g, ...
    uplink_carrier_frequency_5g, downlink_carrier_frequency_5g, backhaul_carrier_frequency_5g, ...
    uplink_bandwidth_4g, uplink_bandwidth_5g, ...
    downlink_bandwidth_4g, downlink_bandwidth_5g, ...
...
avg(:,5) = [];
figure(1)
names = {'original'; '+1 dBm'; '+2 dBm'; '+3 dBm'};
plot(overall);
set(gca,'xtick', 1:4,'xticklabel',names)
set(gca, 'YScale', 'log')
xlabel('Transmit Power (dBm)')
ylabel('Latency (in s)')
legend({'latency'},'Location','northeast')
title('Average Total Delay vs Increasing Transmit Power')
hold off
...
title('Average Delay vs Increasing Transmit Power')
set(gca,'xtick', 1:4,'xticklabel',names)
xlabel('Transmit Power (dBm)')
ylabel('Latency (in s)') 
hold off
