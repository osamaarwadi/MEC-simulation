function [avg_uplink, avg_processing, avg_downlink, avg_backhaul, avg_total] = runSimulationCoupled(num_of_sims, BS, user_count, grid, req_size)
    ...
    for i = 1:num_of_sims
        ...
        U = downlink_greedy_coupled(U, BS);
        U = backhaul(U, BS);
