...
BS2 = BaseStationsSetup(grid, 16, bs_count, mec_count, mec_clock, ...
    uplink_bandwidth_4g*1.2, uplink_bandwidth_5g*1.2, ...
    downlink_bandwidth_4g*1.2, downlink_bandwidth_5g*1.2, ...
    backhaul_bandwidth_4g*1.2, backhaul_bandwidth_5g*1.2, ...
    uplink_carrier_frequency_4g, uplink_carrier_frequency_5g, ...
    downlink_carrier_frequency_4g, downlink_carrier_frequency_5g, ...
    backhaul_carrier_frequency_4g, backhaul_carrier_frequency_5g, ...
    uplink_power, downlink_power, backhaul_power, noise_spectral_density);
...
BS3 = BaseStationsSetup(grid, 16, bs_count, mec_count, mec_clock, ...
    uplink_bandwidth_4g*1.4, uplink_bandwidth_5g*1.4, ...
    downlink_bandwidth_4g*1.4, downlink_bandwidth_5g*1.4, ...
    backhaul_bandwidth_4g*1.4, backhaul_bandwidth_5g*1.4, ...
    uplink_carrier_frequency_4g, uplink_carrier_frequency_5g, ...
    downlink_carrier_frequency_4g, downlink_carrier_frequency_5g, ...
    backhaul_carrier_frequency_4g, backhaul_carrier_frequency_5g, ...
    uplink_power, downlink_power, backhaul_power, noise_spectral_density);
...
BS4 = BaseStationsSetup(grid, 16, bs_count, mec_count, mec_clock, ...
    uplink_bandwidth_4g*1.6, uplink_bandwidth_5g*1.6, ...
    downlink_bandwidth_4g*1.6, downlink_bandwidth_5g*1.6, ...
    backhaul_bandwidth_4g*1.6, backhaul_bandwidth_5g*1.6, ...
    uplink_carrier_frequency_4g, uplink_carrier_frequency_5g, ...
    downlink_carrier_frequency_4g, downlink_carrier_frequency_5g, ...
    backhaul_carrier_frequency_4g, backhaul_carrier_frequency_5g, ...
    uplink_power, downlink_power, backhaul_power, noise_spectral_density);
...
title('Average Total Delay vs Increasing Bandwidth')
hold off
...
plot(x, avg(1:4,:))
legend({'uplink', 'processing', 'downlink', 'backhaul'},'Location','northeast')
title('Average Delay vs Increasing Bandwidth')
set(gca,'xtick', 1:4,'xticklabel',names)
xlabel('Bandwidth')
ylabel('Latency (in s)') 
hold off
