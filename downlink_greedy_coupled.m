function [U, BS_in_range_5g, BS_in_range_4g] = downlink_greedy_coupled(U, BS)
...
for i = 1:length(U)
    if nnz(BS_in_range_5g(i,:)) > 0
        ...
        for j = 1:nnz(BS_in_range_5g(i,:))
            if BS_in_range_5g(i,j) == U(i).uplink_basestation
    ...
    elseif nnz(BS_in_range_4g(i,:)) > 0
        ...
        for j = 1:nnz(BS_in_range_4g(i,:))
            if BS_in_range_4g(i,j) == U(i).uplink_basestation
