...
avg = [];
[avg(1,1), avg(1,2), avg(1,3), avg(1,4), avg(1,5)] = runSimulation(25, BS, user_count, grid, req_size);

[avg(2,1), avg(2,2), avg(2,3), avg(2,4), avg(2,5)] = runSimulationCoupled(25, BS, user_count, grid, req_size);


overall = avg(:,5);
avg(:,5) = [];
figure(1)
names = {'Decoupled'; 'Coupled'};
bar(avg, 'stacked');
...
title('Average Total Delay vs Access Method')
hold off
